try:
    ...
    print("[-] Error! You Dont Have All The Required Modules Installed To Run BatchSheild V2.2 Please Open install.bat To Fix!")
    time.sleep(5)
    exit()
...
Version | V2.2
Made By | DevBubba#6642 
Discord | https://discord.gg/6qAvAephsW 
